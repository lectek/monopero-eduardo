package br.com.minimercadinho.saas.adapters.outbound.ims;
 ...
 * dessa tabela (isso é papel do
 * {@link br.com.minimercadinho.saas.adapters.outbound.persistence.SchemaInitializer})
 * e espelha exatamente as colunas que o IMS já usa em {@code Db.java}, pra
 * ler e gravar estoque em total consistência com o caixa.
 *
